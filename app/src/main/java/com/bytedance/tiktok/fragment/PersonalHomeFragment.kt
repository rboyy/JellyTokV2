...
class PersonalHomeFragment : BaseBindingFragment<FragmentPersonalHomeBinding>({FragmentPersonalHomeBinding.inflate(it)})
    ...
    fun init() {
        try {
            ...
            android.util.Log.e("JellyTok_CRASH", "PersonalHomeFragment.init() CRASH: ${e.message}", e)
        }
    }
    ...
    private fun setTabLayout() {
        val titles = arrayOf("影片 " + curUserBean!!.workCount, "收藏 " + curUserBean!!.dynamicCount, "已看 " + curUserBean!!.likeCount)
        fragments.clear()
